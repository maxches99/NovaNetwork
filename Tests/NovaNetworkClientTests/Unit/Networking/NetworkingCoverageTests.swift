...
actor ThrowingClock: RetryClock {
    func sleep(nanoseconds: UInt64) async throws {
        throw DummyError.boom
    }
}

actor NonCooperativeClock: RetryClock {
    func sleep(nanoseconds: UInt64) async throws {
...
actor CancellationThrowingTransport: NetworkTransport {
    func execute(_ request: APIRequest) async throws -> NetworkResponse {
        throw CancellationError()
    }
}

actor GenericThrowingTransport: NetworkTransport {
    let error: any Error
...
actor SequenceThrowingTransport: NetworkTransport {
...
actor HeaderCapturingTransport: NetworkTransport {
